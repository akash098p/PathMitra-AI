    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-0 sm:p-6">
      <div className="relative w-full max-w-[430px] h-[100dvh] sm:h-[900px] bg-white sm:rounded-[42px] shadow-2xl overflow-hidden border-0 sm:border-[8px] border-[#eee9e3] flex flex-col">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          <span className="absolute -left-24 top-24 h-64 w-64 rounded-full bg-[#fff3eb]/45" />
          <span className="absolute -right-28 top-[-3rem] h-72 w-72 rounded-[42%] rotate-12 bg-[#f5f1ff]/40" />
          <span className="absolute bottom-24 -right-20 h-64 w-64 rounded-full bg-[#effbf4]/45" />
          <span className="absolute bottom-[-5rem] left-10 h-36 w-56 -rotate-12 rounded-[45%] bg-[#fffbea]/50" />
          <span className="absolute left-8 top-1/2 h-20 w-20 rounded-full border-[10px] border-[#ffede5]/50" />
          <span className="absolute right-10 top-1/3 h-5 w-5 rounded-full bg-[#fce6ed]/50" />
        </div>
