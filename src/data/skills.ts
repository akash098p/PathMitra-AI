...
export const SKILL_TRACKS: SkillTrack[] = [
  ...
  {
    id: 'creative-fashion',
    name: 'Creative & Fashion Design Skills',
    emoji: '👗',
    fits: ['creative-arts', 'design', 'media'],
    weeklyHours: '6–10 hours per week',
    timeToFirstProject: '6–8 weeks to a shareable portfolio',
    milestones: [
      'Learn sketching basics — human figures, fabric flow, outfit concepts',
      'One design tool — Canva or Figma for posters, mood boards and lookbooks',
      'Colour theory and fabric basics — what works on different body types',
      'Stitching or tailoring basics at a local boutique or a free video course',
      'Build a fashion/illustration portfolio of 10–15 original looks',
      'Publish the portfolio on Instagram or Behance and enter one student contest',
    ],
    beginnerProjects: [
      'Design a 6-look collection around one festival or season',
      'Restyle 3 outfits from clothes already at home and photograph them',
      'A poster and logo set for a local shop or school event',
      'A mood board for one fashion trend explained in simple words',
    ],
    resources: [
      { label: 'NIFT official portal (entrance + admissions)', url: 'https://www.nift.ac.in' },
      { label: 'NID admissions portal', url: 'https://admissions.nid.edu' },
      { label: 'SWAYAM design courses (free)', url: 'https://swayam.gov.in' },
      { label: 'Canva Design School (free)', url: 'https://www.canva.com/designschool/' },
    ],
    outcomeRoles: ['Fashion design intern', 'Boutique assistant designer', 'Content/design freelancer', 'NIFT/NID aspirant'],
  },
  {
    id: 'performing-arts',
    name: 'Performing Arts & Entertainment Skills',
    emoji: '🎤',
    fits: ['performing-arts', 'media', 'creative-arts'],
    weeklyHours: '6–10 hours per week',
    timeToFirstProject: '4–8 weeks to a first public performance or upload',
    milestones: [
      'Pick one discipline — singing, dancing, acting, or anchoring — and commit for 90 days',
      'Daily 30-minute practice with a recorded log so you can hear/see progress',
      'Learn the basics of filming and lighting with just a phone',
      'Record a clean 2-minute showreel (song, dance, monologue or reel)',
      'Publish weekly on one platform — Instagram, YouTube or a local stage',
      'Perform at one real event — school function, open mic, or local cultural programme',
    ],
    beginnerProjects: [
      'A 60-second reel of your best performance, filmed and edited on a phone',
      'Cover one popular song or dance and publish it',
      'Anchor a two-minute school event video end to end',
      'Organise a 15-minute performance at a local community event',
    ],
    resources: [
      { label: 'SWAYAM arts and culture courses (free)', url: 'https://swayam.gov.in' },
      { label: 'Ministry of Culture — scholarships and programmes', url: 'https://indiaculture.gov.in' },
      { label: 'CCRT talent search scholarships', url: 'https://ccrtindia.gov.in' },
      { label: 'YouTube Creators — learning basics', url: 'https://www.youtube.com/creators/' },
    ],
    outcomeRoles: ['Performer/content creator', 'Event anchor or host', 'Dance/music assistant teacher', 'Short-video creator'],
  },
  {
    id: 'defence-prep',
    name: 'Defence & Armed Forces Preparation',
    emoji: '🎖️',
    fits: ['defence', 'defence-arts', 'govt-service'],
    weeklyHours: '10–14 hours per week',
    timeToFirstProject: '6–12 months to first attempt readiness',
    milestones: [
      'Know your entry first — NDA (after Class 12), CDS (after graduation), AFCAT (Air Force), Agniveer, or technical entries',
      'Running, push-ups and sit-ups to NDA/Agniveer standards, tracked weekly',
      'Maths and English daily practice for the written paper',
      'General knowledge — defence current affairs, aircraft, ships and ranks',
      'SSB interview practice — OIR tests, PPDT stories and group tasks',
      'Music/dance aspirants: one instrument or dance form rehearsed to performance level for armed forces band entries',
    ],
    beginnerProjects: [
      'A one-page entry-route plan for your age and qualification',
      'A weekly fitness log with timings and totals',
      'A daily 30-minute current-affairs and defence-GK note file',
      'One full NDA/CDS/AFCAT past paper attempted under exam timing',
    ],
    resources: [
      { label: 'Join Indian Army — official portal', url: 'https://joinindianarmy.nic.in' },
      { label: 'Agniveer recruitment portal', url: 'https://agnipathvayu.cdac.in' },
      { label: 'Indian Navy — official recruitment', url: 'https://www.joinindiannavy.gov.in' },
      { label: 'AFCAT — Indian Air Force', url: 'https://afcat.cdac.in' },
      { label: 'UPSC — NDA and CDS exams', url: 'https://upsc.gov.in' },
    ],
    outcomeRoles: ['NDA/CDS aspirant', 'Agniveer (Army/Navy/Air Force) aspirant', 'Air Force Airmen / Navy SSR aspirant', 'Armed forces band/music entry aspirant'],
  },
];
